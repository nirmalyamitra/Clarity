...
var common = /** @class */ (function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, protractor_1.browser.executeScript("arguments[0].setAttribute('style', arguments[1]);", element, "color: red; border:3px solid red;")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, protractor_1.browser.executeScript("arguments[0].setAttribute('style', arguments[1]);", element, "")];
                    case 3:
                        _a.sent();
                        _a.label = 4;
                    case 4:
    ...
    common.prototype.writeScreenShot = function (filename) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protractor_1.browser.takeScreenshot().then(function (png) {
    ...
    common.prototype.waitforPage = function (pageUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        condition = protractor_1.ExpectedConditions.urlContains(pageUrl);
                        return [4 /*yield*/, protractor_1.browser.wait(condition, 60000)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    common.prototype.waitForElement = function (element) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        condition = protractor_1.ExpectedConditions.presenceOf(element);
                        return [4 /*yield*/, protractor_1.browser.wait(condition, 60000)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
