...
function spawnBrowser(executablePath, dataDir, isContentShell, options) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const process = new BrowserProcess(executablePath, args);
        try {
            let port = 0;
            let tries = 0;
            while (true) {
...
function getArguments(dataDir, isContentShell, options) {
...
class BrowserProcess {
    constructor(executablePath, args) {
        ...
        const process = child_process_1.spawn(executablePath, args);
