...
function createHTTPClient(host, port) {
...
class HTTPClient {
    ...
    get(path) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const request = http_1.get({ host, port, path });
            const response = yield getResponse(request);
...
function getResponse(request) {
    return __awaiter(this, void 0, void 0, function* () {
        return event_promise_1.eventPromise(request, "response", "error");
    });
}
function readResponseBody(response) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield event_promise_1.eventPromise(response, "end", "error");
        return body;
    });
}
