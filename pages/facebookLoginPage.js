...
var locators = {
    emailIdBox: {
        type: basePage_1.idType[basePage_1.idType.id],
        value: "email"
    },
    passwordBox: {
        type: basePage_1.idType[basePage_1.idType.id],
...
var facebookLoginPage = /** @class */ (function (_super) {
    ...
    function facebookLoginPage() {
        ...
        _this.emailIdBox = _this.ElementLocator(locators.emailIdBox);
        _this.passwordBox = _this.ElementLocator(locators.passwordBox);
    ...
    facebookLoginPage.prototype.get = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, protractor_1.browser.get("http://www.facebook.com")];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
//# sourceMappingURL=facebookLoginPage.js.map